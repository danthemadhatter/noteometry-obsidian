...
> Current as of **v1.7.2**. This is a *public surface* summary — not every internal export. When a detail here disagrees with the source, the source wins; open an issue so this doc can be corrected.
